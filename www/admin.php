...
if (isset($_SESSION['alogin']))
{
    ...
    {       
        if (isset($_POST['rec']) && !empty($_POST['rec']))
        {
            ...
            {       
                $var = explode("+", $iterate);
                $query .= "UPDATE Contains Set received = 1 WHERE ";
                $query .= sprintf("isbn = \"%s\" ", $var[0]);
                $query .= sprintf("AND order_id = %s;", $var[1]);
            }       
    ...
    echo "<INPUT TYPE = \"Submit\" Name = \"generateReport\" VALUE = ";
    ...
    echo "<INPUT TYPE = \"Submit\" Name = \"addBook\" VALUE = ";
    echo "\"Add a Book\">";
    echo "</P>";
    echo "</FORM>";

    echo "<FORM NAME =\"form8\" METHOD =\"POST\" action=\"";
    echo htmlspecialchars($_SERVER["PHP_SELF"]) . "\">";
    echo "<p>";
    echo "<input type=\"hidden\" name=\"page_action\" value=\"4\" />";
    echo "<INPUT TYPE = \"Submit\" Name = \"checkOrder\" VALUE = ";
    ...
    case 3:
        ...
        if (isset($_POST['isbn2']) && isset($_POST['qty2']))
        {
            $inv->addBook($_POST['isbn2'], $_POST['title'], 
                ...
                $_POST['image'], $_POST['qty2']);
        }
        break;
    case 4:
        echo "Check student order.";
        echo "<FORM NAME =\"form7\" METHOD =\"POST\" action=\"";
        echo  htmlspecialchars($_SERVER["PHP_SELF"]) . "\">";
        echo "<p>";
        echo "Student ID: <INPUT TYPE = 'TEXT' Name ='stunum' ";
        echo "maxlength=\"17\">";
        echo "<INPUT TYPE = \"Submit\" Name = \"so\"  VALUE = \"Check\">";
        echo "</p>";
        echo "</FORM><br>";
        echo "<FORM NAME =\"form9\" METHOD =\"POST\" action=\"";
        echo htmlspecialchars($_SERVER["PHP_SELF"]) . "\">";
        echo "<p>";
